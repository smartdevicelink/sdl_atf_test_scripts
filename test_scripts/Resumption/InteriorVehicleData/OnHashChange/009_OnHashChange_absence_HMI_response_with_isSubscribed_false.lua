...
-- 2. HMI sends RC.GetInteriorVehicleData(SUCCESS, isSubscribed = false)
-- SDL does:
...
for _, moduleName in pairs(common.modules)do
  common.Step("Absence OnHashChange after GetInteriorVD(isSubscribe=false) response to " .. moduleName,
