...
-- 4. App starts registration with actual hashId after IGN_ON in 3rd ignition cycle
-- SDL does:
...
runner.Step("Check subscription", common.GetInteriorVehicleData, { common.modules[1], false, 1, 1 })
