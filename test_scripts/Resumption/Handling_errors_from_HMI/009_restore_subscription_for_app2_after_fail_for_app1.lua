...
-- 5. VehicleInfo.SubscribeVehicleData related to app1 is sent from SDL to HMI during resumption
-- 6. VehicleInfo.SubscribeVehicleData_2 request is not sent yet for app2
-- 7. HMI responds with error resultCode VehicleInfo.SubscribeVehicleData_2 request
