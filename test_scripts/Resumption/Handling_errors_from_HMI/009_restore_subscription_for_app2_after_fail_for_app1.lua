...
-- 5. HMI responds with <erroneous> resultCode to VI.SubscribeVehicleData(data_1, data_2) request
-- SDL does:
...
--  - not send VI.UnsubscribeVehicleData(data_1, data_2) request related to app1 to HMI
