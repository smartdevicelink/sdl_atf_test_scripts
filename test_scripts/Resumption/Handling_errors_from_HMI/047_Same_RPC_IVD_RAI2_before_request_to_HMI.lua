...
-- 4. HMI responds with <erroneous> resultCode to request related to App1
-- SDL does:
...
--  - continue resumption for App2 and send RC.GetInteriorVehicleData(subscribe=true) request related to App2 to HMI
-- 5. HMI responds with <successful> resultCode to request related to App2
-- SDL does:
