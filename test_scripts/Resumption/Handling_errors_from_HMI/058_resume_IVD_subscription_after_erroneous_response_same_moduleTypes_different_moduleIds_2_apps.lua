...
--  are sent from SDL to HMI during resumption
-- 7. HMI responds with error resultCode to RC.GetInteriorVehicleData(moduleId_1) request
...
local function checkResumptionData()
  local actualData = {}
  local expectedData = {}
  table.insert(expectedData, common.geInteriorVDvalue("CLIMATE", true, moduleIdsForClimate[1]))
  table.insert(expectedData, common.geInteriorVDvalue("CLIMATE", true, moduleIdsForClimate[2]))
  ...
  table.insert(expectedData, common.geInteriorVDvalue("CLIMATE", false, moduleIdsForClimate[1]))
