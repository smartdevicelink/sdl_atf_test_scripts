...
-- (2nd app re-registers after erroneous response from HMI scenario)
--
-- In case:
...
runner.Step("Reregister Apps resumption", common.reRegisterAppsCustom_AnotherRPC,
  { common.timeToRegApp2.AFTER_ERRONEOUS_RESPONSE, "subscribeVehicleData" })
