...
-- Description:
-- In case:
-- 1. App is connected with NAVIGATION appHMIType and isMediaApplication=false
...
-- 2. Resume app to HMI level specified in `NavigationLowBandwidthResumptionLevel`
---------------------------------------------------------------------------------------------------
