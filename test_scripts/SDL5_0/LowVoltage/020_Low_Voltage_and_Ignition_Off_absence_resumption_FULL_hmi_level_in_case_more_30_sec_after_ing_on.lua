...
-- 6. Mobile app registers with the same hashID in next ignition cycle after 35 seconds after ignition on
-- 7. there is no application currently in FULL
-- SDL does:
...
runner.Step("Wait 35 sec after IGNITION_ON", common.wait, {35000})
