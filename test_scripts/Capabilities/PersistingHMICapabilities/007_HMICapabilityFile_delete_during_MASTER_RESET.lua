...
--
-- Description: Check that SDL deletes HMI capabilities cache (hmi_capabilities_cache.json) file during MASTER_RESET
--
-- Preconditions:
...
common.Step("Check that SDL deletes HMI capabilities cache file", common.checkIfCapabilityCacheFileExists, { false })
