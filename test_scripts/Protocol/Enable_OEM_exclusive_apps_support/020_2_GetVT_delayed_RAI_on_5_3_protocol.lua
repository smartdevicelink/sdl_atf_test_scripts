...
--  '5.3' protocol version in case HMI responds with delay to VI.GetVehicleType request,
--  HMI responds immediately to BC.GetSystemInfo request
--
-- Steps:
...
-- 4. HMI responds with delay to VI.GetVehicleType request and immediately to BC.GetSystemInfo request
-- SDL does:
