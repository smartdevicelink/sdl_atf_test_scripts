...
--  3) Send another StartService Request to start a second protected RPC service
--  SDL Does:
...
--  SDL Does:
--    a) Send a StartService ACK message
--  7) Send another StartService Request to start a second protected RPC service
--  SDL Does:
...
runner.Step("Create Second Protected RPC Service NACK", common.startServiceProtectedNACK, {1, common.serviceType.RPC, rpcServiceParams[1].reqParams, rpcServiceParams[1].nackParams})
...
runner.Step("Create Second Protected RPC Service NACK", common.startServiceProtectedNACK, {1, common.serviceType.RPC, rpcServiceParams[2].reqParams, rpcServiceParams[2].nackParams})
