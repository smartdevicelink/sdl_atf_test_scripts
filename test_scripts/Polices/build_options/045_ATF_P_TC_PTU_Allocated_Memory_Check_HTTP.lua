--UNREADY: 
-- in files/jsons/Policies/Policy_Table_Update/ptu_22421_1Mb.json 
-- should be put json file from https://github.com/smartdevicelink/sdl_atf_test_scripts/pull/321/
...
-- PTU file 1Mb size (exactly) is prepared 
-- 2. Register new app
-- 3. Activate app
-- 2. Performed steps
-- 1. PTU is requested
