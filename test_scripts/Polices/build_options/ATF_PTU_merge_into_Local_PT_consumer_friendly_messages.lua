...
function Test:TestStep_PTU_Merge_Messages ()
  ...
  :Do(function(_,_)
      self.hmiConnection:SendNotification("BasicCommunication.OnSystemRequest",
        { requestType = "PROPRIETARY", fileName = "ptu_file_name", appID = self.HMIappI})
      ...
      :Do(function(_,_)
          ...
          local cor_id_system_request = self.mobileSession:SendRPC("SystemRequest", {requestType = "PROPRIETARY", fileName = "ptu_file_name", appID = self.HMIappID})
