...
-- 2. SDL should return StartServiceACK, encrypt = false to Video
---------------------------------------------------------------------------------------------
...
function Test:TestStep_Video_ACK_encrypt_false()
  ...
  :ValidIf(function(_, data)
      if data.frameInfo == 2 then
        if(data.encryption == true) then
          commonFunctions:printError("Service 11: StartService ACK, encryption: true is received")
          return false
        else
          print("Service 11: StartServiceACK, encryption: false")
          return true
        end
