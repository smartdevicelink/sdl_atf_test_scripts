...
-- PTU file is updated and application is assigned to functional groups: Base-4, user-consent groups: Location-1 and
-- Notifications
-- PTU has passed successfully
-- HMI sends <externalConsentStatus> to SDl via OnAppPermissionConsent (parameter entityType has invalid value, rest of
-- params present and within bounds, EntityStatus = 'ON')
        ...
        :Do(function()
          ...
          :Do(function(_,_)
            self.hmiConnection:SendNotification("SDL.OnAppPermissionConsent",
            {
              ...
              externalConsentStatus = {
                {entityType = params_invalid_data[i].param_value, entityID = 113, status = "ON"}
              },
              source = "GUI"
            })
