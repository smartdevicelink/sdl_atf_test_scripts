...
--------------------------------------------------------------------------
-- Test 04.02:
-- Description: disallowed_by_external_consent_entities_off exists. HMI -> SDL: OnAppPermissionConsent(externalConsentStatus ON, function disallowed)
...
--------------------------------------------------------------------------
-- Precondition:
-- HMI sends OnAppPermissionConsent with consented function = disallowed and External Consent status = ON
--------------------------------------------------------------------------
