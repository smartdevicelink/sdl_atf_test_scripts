...
--------------------------------------------------------------------------
-- Test 12.02:
-- Description: disallowed_by_external_consent_entities_off. HMI -> SDL: OnAppPermissionConsent(externalConsentStatus OFF). Register new applications.
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF.."Precondition_Update_Policy_Table_1"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_RPC_of_Application_1_Group001_is_disallowed"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_RPC_of_Application_2_Group001_is_disallowed"] = function(self)
