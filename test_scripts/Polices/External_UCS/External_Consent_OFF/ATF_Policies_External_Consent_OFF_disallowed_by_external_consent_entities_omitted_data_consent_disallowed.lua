...
--------------------------------------------------------------------------
-- Test 01.04:
-- Description: disallowed_by_external_consent_entities_on/off is omitted. Data consent is disallowed. HMI -> SDL: OnAppPermissionConsent(externalConsentStatus OFF, function allowed)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "Precondition_HMI_sends_OnAllowSDLFunctionality"] = function(self)
...
--------------------------------------------------------------------------
-- Precondition:
-- HMI sends OnAppPermissionConsent with External Consent status = OFF and consented function = allowed
--------------------------------------------------------------------------
