...
--------------------------------------------------------------------------
-- Test 03.03:
-- Description: disallowed_by_external_consent_entities_off exists. User consent is disallowed. HMI -> SDL: OnAppPermissionConsent(externalConsentStatus OFF)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "Precondition_HMI_sends_OnAppPermissionConsent_externalConsentStatus"] = function(self)
  -- hmi side: sending SDL.OnAppPermissionConsent for applications
  self.hmiConnection:SendNotification("SDL.OnAppPermissionConsent", {
      source = "GUI",
