...
--------------------------------------------------------------------------
-- Test 12.01:
-- Description: disallowed_by_external_consent_entities_on. HMI -> SDL: OnAppPermissionConsent(externalConsentStatus OFF). Register new applications.
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_RPC_of_Application_1_Group001_is_allowed"] = function(self)
...
--------------------------------------------------------------------------
Test[TEST_NAME_OFF .. "MainCheck_RPC_of_Application_2_Group001_is_allowed"] = function(self)
