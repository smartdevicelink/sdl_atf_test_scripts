...
---------------------------------------------------------------------------------------------------
-- Description: There is no SDL crash on ignition off during registering Apps
---------------------------------------------------------------------------------------------------
-- Preconditions:
-- 1. SDL and HMI are started
-- Steps:
-- 1. Mobile app starts registration of 5 apps
-- 2. Ignition off is performed during apps registration
-- SDL does:
