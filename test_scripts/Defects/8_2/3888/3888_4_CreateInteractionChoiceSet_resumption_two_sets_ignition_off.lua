...
---------------------------------------------------------------------------------------------------
-- Description:  Check that SDL resumes both CreatedInteractionChoiceSets (one with and one without VR commands) after ignition off
--
-- Precondition:
...
-- 2. Ignition OFF and ON are performed
