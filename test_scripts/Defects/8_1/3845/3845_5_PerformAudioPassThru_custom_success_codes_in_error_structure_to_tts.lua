...
-- HMI responds with not "SUCCESS" result code to TTS.Speak request in error structure
--
-- Steps:
-- 1. HMI and SDL are started
-- 2. Mobile app is registered and activated
-- 3. Mobile app requests PerformAudioPassThru RPC
-- 4. HMI responds to TTS.Speak request in error structure with one of result code:
