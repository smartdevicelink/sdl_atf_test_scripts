...
--
-- Description: SDL should successfully process VR.OnLanguageChange during PTU
--
-- Pre-conditions:
...
--
-- Steps:
-- 1. HMI sends VR.OnLanguageChange after receiving of SystemRequest response by App during PTU processing
-- SDL does:
...
local function performPTUWithVrOnLanguageChange()
  ...
  :Do(function()
      ...
      :Do(function()
          ...
          local corIdSystemRequest = mobile:SendRPC("SystemRequest", { requestType = "PROPRIETARY" }, ptuFileName)
          mobile:ExpectResponse(corIdSystemRequest, { success = true, resultCode = "SUCCESS" })
            :Do(function()
...
common.Title("Test")
common.Step("VR.OnLanguageChange after receiving of SystemRequest response by App during PTU processing",
