...
local function receiveButtonPressWithAppId()
  ...
  mobSession1:ExpectNotification("OnButtonEvent",{buttonName = "OK", buttonEventMode="BUTTONDOWN"}):Times(1)
  common.hmi.getConnection():SendNotification("Buttons.OnButtonPress", {name = "OK", mode = "LONG", appID = common.app.getHMIId(1)})
  mobSession1:ExpectNotification("OnButtonPress",{buttonName = "OK", buttonPressMode = "LONG"}):Times(1)
end
