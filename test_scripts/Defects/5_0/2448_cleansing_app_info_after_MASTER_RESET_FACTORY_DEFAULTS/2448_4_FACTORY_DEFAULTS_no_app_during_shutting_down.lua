...
-- 7. HMI sends BC.OnExitAllApplications(reason = FACTORY_DEFAULTS)
-- SDL does:
--  a. clear app's persist data
--  b. stop working
-- 8. HMI and SDL are started
-- 9. App registers with actual hashID
-- SDL does:
...
--[[ Local Variables ]]
local shutDownReason = "FACTORY_DEFAULTS"
...
common.Step("Start SDL, HMI, connect Mobile", common.start)
common.Step("App registration without resumption", common.appResumption)
