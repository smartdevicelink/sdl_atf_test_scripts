...
---------------------------------------------------------------------------------------------------
-- Description: SDL sends SubtleAlert response with UNSUPPORTED_RESOURCE, success:false for single UI-related RPC
...
-- Steps:
-- 1. App requests SubtleAlert only with UI part to SDL
-- SDL does:
-- - not send UI.SubtleAlert request to HMI
-- - respond SubtleAlert(resultCode: UNSUPPORTED_RESOURCE, success: false) to App
---------------------------------------------------------------------------------------------------
...
common.Title("Test")
common.Step("App sends SubtleAlert", common.sendRPC, { rpcParams })
