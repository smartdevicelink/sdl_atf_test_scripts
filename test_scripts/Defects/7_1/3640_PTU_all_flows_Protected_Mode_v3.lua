----------------------------------------------------------------------------------------------------
-- Issue: https://github.com/smartdevicelink/sdl_core/issues/3640
----------------------------------------------------------------------------------------------------
-- Description: Check SDL is able to perform PTU over secure connection using 3rd version of
-- SDL protocol
--
-- Steps:
-- 1. New app is registered
-- 2. App establishes secure connection (start protected RPC service)
-- SDL does:
--  - Start PTU sequence (since App is a new one)
--  - Finish PTU sequence successfully
----------------------------------------------------------------------------------------------------
