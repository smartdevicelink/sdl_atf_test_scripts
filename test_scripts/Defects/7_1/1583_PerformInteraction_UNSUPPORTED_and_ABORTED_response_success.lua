---------------------------------------------------------------------------------------------------
-- User story: https://github.com/SmartDeviceLink/sdl_core/issues/1583
--
-- Description:
-- HMI responds with UNSUPPORTED_RESOURCE to UI.PerformInteraction and ABORTED to VR.PerformInteraction
--
-- Preconditions:
-- 1) Clean environment
...
--    and choiceID for UI portion, sends ABORTED for VR portion
--
-- Expected:
...
local function performInteraction(pAppId)
  ...
  :Do(function(_, data)
    ...
    local function uiResponse()
      ...
      if vrId ~= 0 then
        common.getHMIConnection():SendResponse(vrId, "VR.PerformInteraction", "ABORTED", {})
