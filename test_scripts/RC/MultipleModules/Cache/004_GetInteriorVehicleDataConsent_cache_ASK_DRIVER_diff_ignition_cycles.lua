...
-- 3) Perform ignition off, ignition on (new ignition cycle started)
--    Set RC access mode to ASK_DRIVER
--    Reregister App1 and App2 and activate App2
...
for moduleType, consentArray in pairs(testModules) do
  for moduleId, isAllowed in pairs(consentArray) do
    runner.Step("Try to reallocate module [" .. moduleType .. ":" .. moduleId .. "] with "
      ...
      common.getAllocationFunction(testModules[moduleType][moduleId], true),
...
runner.Step("Register App2 again", common.registerAppWOPTU, { 2 })
runner.Step("Activate App1", common.activateApp, { 1 })
runner.Step("Send user location of App1 (Back Seat)", common.setUserLocation, { 1, appLocation[1] })
runner.Step("Activate App2", common.activateApp, { 2 })
runner.Step("Send user location of App2 (Back seat)", common.setUserLocation, { 2, appLocation[2] })
...
for moduleType, consentArray in pairs(testModules) do
  for moduleId, isAllowed in pairs(consentArray) do
    runner.Step("Try to reallocate " .. tostring(isAllowed and "allowed" or "disallowed")
      .. " module [" .. moduleType .. ":" .. moduleId .. "] without asking driver for consent to App1",
