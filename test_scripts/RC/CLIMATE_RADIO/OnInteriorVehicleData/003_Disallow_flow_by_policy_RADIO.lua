...
-- Use case: https://github.com/smartdevicelink/sdl_requirements/blob/master/detailed_docs/RC/Policy_Support_of_basic_RC_functionality.md
...
runner.Step("OnInteriorVehicleData " .. mod, commonRC.isUnsubscribed, { "CLIMATE" })
