---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [Policies] PTU one invalid and other valid values in "RequestType" array
--
-- Check SDL behavior in case optional parameter ith invalid type in received PTU
-- 1. Used preconditions:
-- Do not start default SDL
-- Prepare PTU file with "<appID>" policies and "RequestType" has one invalid value and other are valid
-- Start SDL
