---------------------------------------------------------------------------------------------
-- Requirement summary:
-- [Policies] PTU the only one invalid value in "RequestType" array
--
-- Check SDL behavior in case optional parameter ith invalid type in received PTU
-- 1. Used preconditions:
-- Do not start default SDL
-- Prepare PTU file with "<appID>" policies and "RequestType" array contains only one value and it is invalid
-- Start SDL
