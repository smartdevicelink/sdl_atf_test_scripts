...
-- Non-navi app exists in LP, no certificate in module_config
--
-- 2. Performed steps
-- 2.1 Register and activate non-navi application
-- 2.2 Perform PTU with NO certificate
-- 2.3 Start secure RPC service
--
-- Expected result:
-- 1. SDL sends SDL.OnStatusUpdate(UPDATE_NEEDED)
-- 2. SDL finishes PTU successfully: SDL.OnStatusUpdate(UP_TO_DATE)
-- 3. SDL returns StartServiceACK, encrypt = false to RPC
---------------------------------------------------------------------------------------------
...
testCasesForPolicyCeritificates.update_preloaded_pt(nil, false)
