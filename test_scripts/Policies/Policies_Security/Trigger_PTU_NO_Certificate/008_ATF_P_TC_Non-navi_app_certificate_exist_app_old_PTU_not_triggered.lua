...
-- Non-Navi app exists in LP, certificate is listed in module_config
--
-- 2. Performed steps
-- Register non-navi application
--
-- Expected result:
-- Application is registered successfully
-- SDL doesn't trigger PTU: SDL.OnStatusUpdate(UPDATE_NEEDED) is not sent
---------------------------------------------------------------------------------------------
