...
runner.Step("PutFile. Session Insecure. Sent data UNprotected", commonDTLS.putFileByFrames, {
  { isSessionEncrypted = false, isSentDataEncrypted = false }
})

runner.Step("PutFile. Session Insecure. Sent data UNprotected + Unexpected frame", commonDTLS.putFileByFrames, {
...
runner.Step("PutFile. Session Secure. Sent data UNprotected", commonDTLS.putFileByFrames, {
  { isSessionEncrypted = true, isSentDataEncrypted = false }
})

runner.Step("PutFile. Session Secure. Sent data UNprotected + Unexpected frame", commonDTLS.putFileByFrames, {
  { isSessionEncrypted = true, isSentDataEncrypted = false, isUnexpectedFrameInserted = true }
})

runner.Step("PutFile. Session Secure. Sent data Protected", commonDTLS.putFileByFrames, {
  { isSessionEncrypted = true, isSentDataEncrypted = true }
})

runner.Step("PutFile. Session Secure. Sent data Protected + Unexpected frame", commonDTLS.putFileByFrames, {
