...
-- Description:
-- In case:
-- 1) Update hmiCapabilities for videoStreamingCapability param (pixelPerInch)
-- 2) Mob app sends GetSystemCapability request to SDL
-- SDL does:
-- 1) Send response to Mobile only with pixelPerInch param for videoStreamingCapability
---------------------------------------------------------------------------------------------------
