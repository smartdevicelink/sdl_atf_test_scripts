...
--[[ Functions]]
function m.getDefaultHMICapabilities()
    local path_to_file = config.pathToSDL .. "/hmi_capabilities.json"
    local capabilities = utils.jsonFileToTable(path_to_file)
...
function m.getUpdatedHMIValue(pDiagonalSize, pPixelPerInch, pScale)
