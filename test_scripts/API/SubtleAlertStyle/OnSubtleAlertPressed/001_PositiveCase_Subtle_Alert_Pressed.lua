...
-- User selects SubtleAlert prompt directly
...
-- SDL receives UI.OnSubtleAlertPressed notification for appID1
...
local function subtleAlertTwoApps(pParams)
  ...
  :Do(function(_, data)
      ...
      local function alertResponseStealFocus()
        ...
        common.getHMIConnection():SendNotification("UI.OnSubtleAlertPressed", { 
  ...
  common.getMobileSession():ExpectNotification("OnSubtleAlertPressed", { })
...
runner.Title("Test")
runner.Step("OnSubtleAlertPressed with app activation", subtleAlertTwoApps, { allParams })
