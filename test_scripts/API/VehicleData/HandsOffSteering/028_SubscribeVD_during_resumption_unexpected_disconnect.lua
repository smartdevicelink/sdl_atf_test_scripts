...
--
-- Description: Check that SDL restores the subscription for 'handsOffSteering' data after unexpected disconnect
--
-- Preconditions:
...
common.Step("Check resumption of subscription using OnVehicleData notification", common.sendOnVehicleData)
