---------------------------------------------------------------------------------------------------
-- Description: The app is able to retrieve the parameter in case app version is more then API version
  -- and parameter version, parameter is listed in DB and API and parameter in DB has version more than version of API

-- In case:
-- 1. App is registered with syncMsgVersion=8.0
-- 2. Parameter has since=5.0 in API and since 6.1 in DB
