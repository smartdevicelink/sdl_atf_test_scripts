...
--
-- Description: Check that SDL resumes the subscription for 'windowStatus' parameter for two Apps
...
-- 3) HMI sends OnVehicleData notification with subscribed VehicleData
-- SDL does:
