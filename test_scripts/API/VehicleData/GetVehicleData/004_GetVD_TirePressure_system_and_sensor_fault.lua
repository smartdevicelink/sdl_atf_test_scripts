...
local pressureDataSet = {status = "NORMAL", tpms = "SYSTEM_ACTIVE", pressure = tirePressureValue}
local systemFaultDataSet = {status = "FAULT", tpms = "SYSTEM_FAULT"}
local sensorFaultDataSet = {status = "FAULT", tpms = "SENSOR_FAULT"}
...
runner.Title("Test")
runner.Step("GetVehicleData_tirePressure_system_fault", processRPCInvalidData,
   {{ tirePressure = {
		pressureTelltale = "ON",
		leftFront = pressureDataSet,
		rightFront = pressureDataSet,
		leftRear = systemFaultDataSet,
		rightRear = pressureDataSet
	}}})

runner.Step("GetVehicleData_tirePressure_sensor_fault", processRPCInvalidData,
   {{ tirePressure = {
                pressureTelltale = "ON",
                leftFront = pressureDataSet,
                rightFront = pressureDataSet,
                leftRear = sensorFaultDataSet,
                rightRear = pressureDataSet
        }}})
