...
-- 2. And HMI sends OnVehicleData with inbound max value (1000) for the one of the following parameters:
-- "pdop", "hdop", "vdop"
-- SDL does:
...
for _, p in pairs(common.params) do
  runner.Step("Send OnVehicleData param " .. p .. "=" .. tostring(value), sendOnVehicleData, { p })
end
