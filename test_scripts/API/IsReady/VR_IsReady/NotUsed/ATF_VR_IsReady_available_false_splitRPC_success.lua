...
-- Verify functional requirement APPLINK-25042: [VR Interface] VR.IsReady(false) -> HMI respond with successful resultCode to spitted RPC
---------------------------------------------------------------------------------------------
...
--APPLINK-25042: [VR Interface] VR.IsReady(false) -> HMI respond with successful resultCode to spitted RPC
...
-- AddCommand		
commonFunctions:newTestCasesGroup("AddCommand_UNSUPPORTED_RESOURCE_true_Other_Interfaces_Responds_SUCCESS")
...
-- DeleteCommand	
commonFunctions:newTestCasesGroup("DeleteCommand_UNSUPPORTED_RESOURCE_true_Other_Interfaces_Responds_SUCCESS")
for i = 1, #TestData do
