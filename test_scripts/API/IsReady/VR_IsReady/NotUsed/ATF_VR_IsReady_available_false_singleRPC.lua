...
-- Verify functional requirement APPLINK-20931: [VR Interface] Conditions for SDL to respond 'UNSUPPORTED_RESOURCE, success:false' to mobile app (single VR-related RPC)
---------------------------------------------------------------------------------------------
...
--APPLINK-20931: [VR Interface] Conditions for SDL to respond 'UNSUPPORTED_RESOURCE, success:false' to mobile app (single VR-related RPC)
...
-- 1. Add.Command		
Test["AddCommand_VRCommandsOnly_UNSUPPORTED_RESOURCE_false"] = function(self)
...
Test["DeleteCommand_VRCommandsOnly_UNSUPPORTED_RESOURCE_false"] = function(self)
...
Test["CreateInteractionChoiceSet_1"] = function(self)
