...
------------------------------------------------------------------------------------------------------------------------
-- Description: Check that SDL responds with GENERIC_ERROR:false to SubscribeButton request if HMI doesn't respond
...
-- - respond SubscribeButton(GENERIC_ERROR) to mobile app
