...
------------------------------------------------------------------------------------------------------------------------
-- Description: Check that SDL sends one SubscribeButton RPC with 'CUSTOM_BUTTON' parameter during resumption
--  after unexpected disconnect in case App is subscribed to 'CUSTOM_BUTTON' from App
------------------------------------------------------------------------------------------------------------------------
-- In case:
-- 1. Mobile app is subscribed to 'CUSTOM_BUTTON' from App
