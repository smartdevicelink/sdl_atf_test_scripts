...
local function DiagnosticMessage( )
  ...
  :Timeout(11000)
  :ValidIf(function()
    local checkResult, resultMessage = common.responseTimeCalculation(10000, _, requestTime)
  ...
  :Timeout(14000)
  :ValidIf(function()
    local checkResult, resultMessage = common.responseTimeCalculation(13000)
    return checkResult, resultMessage
  end)
end
