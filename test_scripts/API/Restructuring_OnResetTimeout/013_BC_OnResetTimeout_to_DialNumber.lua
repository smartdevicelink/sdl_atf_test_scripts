...
local function DialNumber()
  ...
  :ValidIf(function()
    ...
    if timeBetweenRespAndNot >= respTimeExpect - 500 and timeBetweenRespAndNot <= respTimeExpect + 500 then
      return true
    else
      return false, "Response is received in some unexpected time. Actual time is " .. timeBetweenRespAndNot ..
      ". Expected time is " .. respTimeExpect
    end
  end)
end
