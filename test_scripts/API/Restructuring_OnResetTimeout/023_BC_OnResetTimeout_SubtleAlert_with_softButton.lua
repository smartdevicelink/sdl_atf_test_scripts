...
-- Description:
-- In case:
-- 1) SubtleAlert with softButton is requested
-- 2) HMI sends response in 17 seconds after response receiving for first request
-- 3) SubtleAlert with softButton is requested
...
-- SDL does:
-- 1) not apply SubtleAlert timeout and not reset timeout by BC.OnResetTimeout
