...
--  - and HMI provides 'OnResetTimeout(resetPeriod)' for both requests
...
-- 3) HMI sends 'BC.OnResetTimeout' notifications to SDL for both requests right after receiving them:
