...
runner.Title("Test")
runner.Step("Close Application for App_1 in FULL level", common.closeApplicationRPCSucces)
runner.Step("App_1 activate", common.activateApp, { 1 })
runner.Step("Set HMI Level to Limited)", common.hmiLeveltoLimited)
runner.Step("Close Application for App_1 in LIMITED level", common.closeApplicationRPCSucces)
runner.Step("App_1 activate", common.activateApp, { 1 })
runner.Step("Set App_1 to HMI Level - BACKGROUND)", common.activateApp, { 2 })
runner.Step("Close Application for App_1 in BACKGROUND level", common.closeApplicationRPCSucces)
