...
-- In InitHMI_OnReady HMI replies with parameter resultCode that has value GENERIC_ERROR in json message to UI.GetCapabilities
...
function Test:Precondition_InitHMI_OnReady()
	...
	:Do(function(_,data)
		self.hmiConnection:Send('{"id":' .. tostring(data.id) .. ',"jsonrpc":"2.0","result":{"available":true,"method":"UI.GetCapabilities", "code":22}}')
	end)
end
