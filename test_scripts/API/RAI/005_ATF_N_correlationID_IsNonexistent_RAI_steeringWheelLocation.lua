...
-- In InitHMI_OnReady HMI replies with correlationID that doesn't exist in json message to UI.GetCapabilities
...
function Test:Precondition_InitHMI_OnReady()
	...
	:Do(function(_,data)
		self.hmiConnection:Send('{"id":'..tostring(data.id + 10)..',"jsonrpc":"2.0","result":{"available":true,"method":"UI.GetCapabilities", "code":0}}')
	end)
end
