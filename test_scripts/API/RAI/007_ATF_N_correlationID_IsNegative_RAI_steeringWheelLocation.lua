...
-- In InitHMI_OnReady HMI replies with correlationID has negative value in json message to UI.GetCapabilities
...
function Test:Precondition_InitHMI_OnReady()
	...
	:Do(function(_,_)
		self.hmiConnection:Send('{"id":'..tostring(-1)..',"jsonrpc":"2.0","result":{"available":true,"method":"UI.GetCapabilities", "code":0}}')
	end)
end
