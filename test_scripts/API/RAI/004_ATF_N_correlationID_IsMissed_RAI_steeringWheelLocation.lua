...
-- In InitHMI_OnReady HMI replies with correlationID missing in json message to UI.GetCapabilities
...
function Test:Precondition_InitHMI_OnReady()
	...
	:Do(function(_,_)
		self.hmiConnection:Send('{"jsonrpc":"2.0","result":{"available":true,"method":"UI.GetCapabilities", "code":0}}')
	end)
end
