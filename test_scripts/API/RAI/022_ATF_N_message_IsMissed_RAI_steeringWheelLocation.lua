...
-- In InitHMI_OnReady HMI replies with parameter message that is missing in json message to UI.GetCapabilities
...
function Test:Precondition_InitHMI_OnReady()
	...
	:Do(function(_,data)
		self.hmiConnection:Send('{"id":'..tostring(data.id)..',"jsonrpc":"2.0","error":{"data":{"method":"UI.GetCapabilities"}, "code":11}}')
	end)
end
