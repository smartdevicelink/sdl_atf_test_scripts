...
-- In InitHMI_OnReady HMI replies with parameter message with value in out of upper bound in json message to UI.GetCapabilities
...
function Test:Precondition_InitHMI_OnReady()
	...
	:Do(function(_,data)
	  ...
	  self.hmiConnection:Send('{"id":'..tostring(data.id)..',"jsonrpc":"2.0","error":{"data":{"method":"UI.GetCapabilities"}, "message":"' .. messageValue ..'","code":11}}')
	end)
end
