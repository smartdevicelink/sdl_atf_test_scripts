...
-- In InitHMI_OnReady HMI replies with parameter method that has invalid character 'tab' in json message to UI.GetCapabilities
...
function Test:Precondition_InitHMI_OnReady()
	...
	:Do(function(_,data)
		self.hmiConnection:Send('{"id":'..tostring(data.id)..',"jsonrpc":"2.0","result":{"available":true,"method":"UI.GetCapabil\tities", "code":0}}')
	end)
end
