...
--1.1. Request is sent with with invalid image parameter in audioPassThruIcon, all other params used in PerformAudioPassThru_request are present and within bounds 
--2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon with invalid image type, other params) from mobile to SDL and check:
...
function Test:TestStep_All_Params_audioPassThruIcon_InvalidType_Image()
