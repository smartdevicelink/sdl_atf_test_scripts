...
--1.1. Request is sent with invalid value parameter in audioPassThruIcon (integer instead of string), all other params used in PerformAudioPassThru_request are present and within bounds 
--2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon with value = 123, other params) from mobile to SDL and check:
...
function Test:TestStep_All_Params_audioPassThruIcon_InvalidType_Value()
