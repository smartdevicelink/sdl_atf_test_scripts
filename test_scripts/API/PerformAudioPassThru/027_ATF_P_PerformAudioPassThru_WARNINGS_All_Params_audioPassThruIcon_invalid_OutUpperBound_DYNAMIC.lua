...
--1.1. Request is sent with audioPassThruIcon that is out of upper bound (actual Ubuntu limitation is 255 chars) and is with type DYNAMIC, all other params used in PerformAudioPassThru_request are present and within bounds 
--2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon out of upper bound, other params) from mobile to SDL and check:
...
function Test:TestStep_All_Params_audioPassThruIcon_OutUpperBound_DYNAMIC()
