...
--1.1. Request is sent with audioPassThruIcon that contains tab charachter  and is with type DYNAMIC, all other params used in PerformAudioPassThru_request are present and within bounds 
--2. Performed steps
-- Send PerformAudioPassThru (audioPassThruIcon  contains tab charachter , other params) from mobile to SDL and check:
...
function Test:TestStep_All_Params_audioPassThruIcon_TabChar_DYNAMIC()
