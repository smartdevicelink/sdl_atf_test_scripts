...
--1.1. Request is sent with audioPassThruIcon that is out of upper bound (actual Ubuntu limitation is 255 chars) and is with type STATIC and with all mandatory parameters within bounds (samplingRate, maxDuration, bitsPerSample, audioType)
--2. Performed steps
...
function Test:TestStep_Mandatory_Params_audioPassThruIcon_OutUpperBound_STATIC()
