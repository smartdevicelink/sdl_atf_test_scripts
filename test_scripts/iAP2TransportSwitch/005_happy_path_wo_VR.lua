...
local function getHMIParams()
  ...
  params.VR.GetLanguage = nil
  params.VR.ChangeRegistration = nil
  params.VR.GetSupportedLanguages = nil
  params.VR.GetCapabilities = nil
  params.VR.IsReady.params.available = false
  return params
end
...
runner.Step("Start SDL, HMI", common.start, { getHMIParams() })
