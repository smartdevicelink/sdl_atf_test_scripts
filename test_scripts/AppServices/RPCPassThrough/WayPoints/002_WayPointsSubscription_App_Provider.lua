...
--
--  Steps:
--  1) app2 sends a SubscribeWayPoints request to Core, HMI receives SubscribeWayPoints request and responds with SUCCESS
...
--
--  Steps:
--  1) app2 sends a UnsubscribeWayPoints request to Core, HMI receives UnsubscribeWayPoints request and responds with SUCCESS
--  2) app1 sends OnWayPointChange notification to Core
--  3) HMI sends Navigation.OnWayPointChange notification to Core
--
--  Expected:
