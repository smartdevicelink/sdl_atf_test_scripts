...
--! @parameters: exp_occur - times to wait TTS.<<RPC>>
--! in case TTS.IsReady(available = false), exp_occur = 0, else exp_occur = 1
--]]
function testCasesForTTS_IsReady.InitHMI_onReady_without_TTS_IsReady(self, exp_occur)
